 ...
 */
public class HouseInfFt extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View fv = inflater.inflate(R.layout.f_mana_houseinf, container, false);

        //register keycode_search push down of searchView
        ((SearchView)fv.findViewById(R.id.f_mana_hsinf_sv)).setOnKeyListener(new View.OnKeyListener() {
            @Override
