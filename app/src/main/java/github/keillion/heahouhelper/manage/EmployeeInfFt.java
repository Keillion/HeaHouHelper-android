 ...
 */
public class EmployeeInfFt extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View fv = inflater.inflate(R.layout.f_mana_employeeinf, container, false);

        //register keycode_search push down of searchView
        ((SearchView)fv.findViewById(R.id.f_mana_epeinf_sv)).setOnKeyListener(new View.OnKeyListener() {
            @Override
